...
public class MoshWeightedGraph {
    ...
    public int getShortestDistance(String from, String to) {
        Node fromNode = nodes.get(from);
        PriorityQueue<NodeEntry> queue = new PriorityQueue<>(Comparator.comparing(nodeEntry -> nodeEntry.priority));
...
//    =================== Minimum Spanning Tree (Prim's algorithm) ================================
    public MoshWeightedGraph getMinimumSpanningTree() {
        MoshWeightedGraph tree = new MoshWeightedGraph();
        ...
        if (edges.isEmpty()) return tree;   // return empty tree
